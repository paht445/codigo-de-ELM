function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] =ELM2(TTRAI, PTRAI, TTEST, PTEST, Elm_Type, NumberofHiddenNeurons, ActivationFunction,C)
...
[x,posx1] = find(T==1);
[x,posx2] = find(T==2);
MEDIA=round(mean([length(posx1) length(posx2)]));
clear x;
