function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,test_gmean] ...
    = ELMdes1(TTRAI, PTRAI, TTEST, PTEST, Elm_Type, NumberofHiddenNeurons, ActivationFunction,C)
...
InputWeight=rand(NumberofHiddenNeurons,NumberofInputNeurons)*0.1-0.05;%MATRIZ DE DATOS ALEATORIOS PARA LOS PESOS, CONSTANTE POR CORRIDAS
BiasofHiddenNeurons=rand(NumberofHiddenNeurons,1)*0.1-0.05;%VECTOR DE DATOS ALEATORIOS PARA LOS BIAS, CONSTANTE POR CORRIDAS
